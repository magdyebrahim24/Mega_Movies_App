  ...
  'movie':[
    {
      ...
      'DescVideo': 'assets/movies/avengers/avengers.mp4',
      'actor': [
        {
          'ActorName': 'Robert',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/fast_furious/fast_furious.mp4',
      'actor': [
        {
          'ActorName': 'Idris',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/john_wick/john_wick.mp4',
      'actor': [
        {
          'ActorName': 'Halle',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/king_of_the_monsters/king.mp4',
      'actor': [
        {
          'ActorName': 'Kyle',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/kong/kong.mp4',
      'actor': [
        {
          'ActorName': 'Beyonce',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/lion_king/lionking.mp4',
      'actor': [
        {
          'ActorName': 'Donald',
    ...
    },
    {
      ...
      'Description':
      'The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks compels the remaining Avengers to take one',
      'DescVideo': 'assets/movies/the_rook/the_rook.mp4',
      'actor': [
        {
          'ActorName': 'Emma',
